...
void insereLivros(){
    lista.livros[0].codigo = 5632;
    lista.livros[0].nome = "It a Coisa";
    lista.livros[0].autor = "Sthepen King";
    lista.livros[0].anoPublicacao = 1998;
    lista.quantidade++;
    lista.livros[1].codigo = 7439;
    lista.livros[1].nome = "It a Coisa 2";
    lista.livros[1].autor = "Sthepen King";
    lista.livros[1].anoPublicacao = 1999;
    lista.quantidade++;
    lista.livros[2].codigo = 7412;
    lista.livros[2].nome = "Objetos Cortantes";
    lista.livros[2].autor = "Gillian Flynn";
    lista.livros[2].anoPublicacao = 2006;
    lista.quantidade++;
}